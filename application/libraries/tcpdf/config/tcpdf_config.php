 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'TUP Administrator');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'TUP Administrator');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Tracer Study');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "By TUP Administrator");
